...
<body class="bg-gray-50" x-data="adminApp" x-init="init()">
  ...
  <script src="https://cdn.jsdelivr.net/npm/@alpinejs/csp@3.16.2/dist/cdn.min.js" defer></script>
